    ...
    <header className="main-header" style={!showSearch ? { justifyContent: 'flex-end' } : {}}>
      ...
      <div className="header-actions">
        ...
        <div className="header-profile-container" ref={dropdownRef}>
          ...
          >
            <img src={user?.profileImage ? `${import.meta.env.VITE_API_URL || 'http://localhost:5000'}${user.profileImage}` : "https://placehold.co/32x32"} alt="Profile" className="header-avatar" />
